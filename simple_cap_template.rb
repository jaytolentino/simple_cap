...
class SimpleCap
  ...
  #
  # Given the following input, create an initial cap table.
  #
  # Input:
  #
  ...
  # e.g. 0.001 for $0.001
  def initialize(founders_to_equity_percent, total_shares, price_per_share: 0.001)
  ...
  # Input:
  #
  # investor_to_terms: hash with a string key representing the investor's name
  # and an array of terms shaped like example below
  # e.g. {
  #   '100X Ventures' => [
  #     1_500_000,   # Amount invested
  #     0.20,        # 20% discount
  #     12_000_000,  # $12M valuation cap
  #   ]
  # }
  #
  # Output:
  ...
  # name an int value for the investment amount
  # e.g. { 'Next Stage VC' => 4_500_000 }
  #
  # pre_money_valuation: int representing the company's pre-money valuation
  # e.g. 20_000_000
  #
  # Output:
...
# Part 2
sc.add_safes({
  'Opaque Ventures'  => [500_000,   0.2,  0],          # 20% discount, no val cap
  'BlackBox Capital' => [1_000_000, 0.0,  10_000_000], # no discount, 10M val cap
  'Sandy Hills VC'   => [1_500_000, 0.15, 15_000_000], # 15% discount, 15M val cap
})

# Part 3
puts sc.add_priced_round({
  'Cormorant Ventures' => 4_000_000,
  'Provident Capital'  => 2_000_000,
  'BlackBox Capital'   => 1_000_000,
}, 15000000).sum(&:value)